...
public class AUTONVisionShootingSequenceCMDGroup extends SequentialCommandGroup {
  
  /** Creates a new VisionShootingSequenceCMDGroup. */
  public AUTONVisionShootingSequenceCMDGroup(DriveTrain m_dDriveTrain, intake m_intake, Door m_door, spoinkVision2 m_vision2, SpoinkVision m_vision) {
